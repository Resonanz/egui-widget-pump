...
* Crates.io: https://crates.io/crates/egui-widget-shapes
* docs.rs: https://docs.rs/egui-widget-shapes
* Github: https://github.com/Resonanz/egui-widget-shapes
...
## What is egui-widget-shapes?

egui-widget-shapes is an egui widget that combines an icon and text. Such an arrangement is often found in modern UIs.
...
```
[dependencies]
egui-widget-shapes = 0.1.0  <--- The latest version number can be found on Crates.io.
```

Or you could use the following if developing locally:
```
[dependencies]
egui-widget-shapes = { path = "/Github/egui-widget-shapes/" }
```
